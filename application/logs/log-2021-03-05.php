...
ERROR - 05-03-2021 17:44:15 --> 404 Page Not Found --> 
<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed'); ?>
...
ERROR - 05-03-2021 17:44:15 --> 404 Page Not Found --> 
ERROR - 05-03-2021 17:44:15 --> 404 Page Not Found --> 
ERROR - 05-03-2021 18:02:46 --> Query error: ERROR:  kolom « kdregu » tidak ada
LINE 77:           coalesce(trim(kdregu              ::text),'') as k...
                                 ^ - Invalid query: select coalesce(trim(branch              ::text),'') as branch              ,
								...
								where a.tglkeluarkerja is null) as x where nik is not null 
								
ERROR - 05-03-2021 19:31:26 --> Query error: ERROR:  kolom « kdregu » tidak ada
LINE 77:           coalesce(trim(kdregu              ::text),'') as k...
                                 ^ - Invalid query: select coalesce(trim(branch              ::text),'') as branch              ,
										coalesce(trim(nik                 ::text),'') as nik                 ,
										coalesce(trim(nmlengkap           ::text),'') as nmlengkap           ,
...
ERROR - 05-03-2021 19:33:33 --> 404 Page Not Found --> bpjs/inputform_bpjs
ERROR - 05-03-2021 19:33:36 --> 404 Page Not Found --> bpjs/editform_bpjs
ERROR - 05-03-2021 19:33:39 --> 404 Page Not Found --> bpjs/deleteform_bpjs
ERROR - 05-03-2021 19:41:15 --> You did not select a file to upload.
ERROR - 05-03-2021 20:23:43 --> You did not select a file to upload.
ERROR - 05-03-2021 20:29:40 --> You did not select a file to upload.
ERROR - 05-03-2021 20:32:16 --> Unable to connect to the database
ERROR - 05-03-2021 21:44:38 --> You did not select a file to upload.
ERROR - 05-03-2021 21:50:43 --> You did not select a file to upload.
ERROR - 05-03-2021 21:55:50 --> You did not select a file to upload.
