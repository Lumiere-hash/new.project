			...
			<thead>
				...
				<tr>
					...
					<td width="15%">
							...
							<a href="<?php echo site_url('ga/inventaris/approval_view_perawatanasset').'/'.trim($row->nodok);?>" class="btn btn-success btn-sm"><i class="fa fa-check" title="Approval 1"></i></a>
