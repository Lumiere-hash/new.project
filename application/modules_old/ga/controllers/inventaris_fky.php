...
/*		
	...
	function perawatanspk_pagin(){
		...
		foreach ($list as $lpo) {
			...
			$row[] = '
			<a class="btn btn-sm btn-default" href="'.site_url('ga/inventaris/detail_inputspk').'/'.$lpo->nodok.'" title="Detail SPK"><i class="glyphicon glyphicon-search"></i> Detail </a>
			<a class="btn btn-sm btn-warning" href="'.site_url('ga/inventaris/sti_po_final').'/'.trim($lpo->nodok).'" target="_blank" title="Cetak PO"><i class="glyphicon glyphicon-search"></i> Cetak </a>
			...
			$row[] = '
			<a class="btn btn-sm btn-default" href="'.site_url('ga/inventaris/detail_inputspk').'/'.$lpo->nodok.'" title="Detail SPK"><i class="glyphicon glyphicon-search"></i> Detail </a>
			<a class="btn btn-sm btn-primary" href="'.site_url('ga/inventaris/edit_inputspk').'/'.$lpo->nodok.'"  target="_blank"  title="Edit SPK"><i class="glyphicon glyphicon-pencil"></i> Edit </a>
			...
			<a class="btn btn-sm btn-warning" href="'.site_url('ga/inventaris/sti_spk_perawatan').'/'.$lpo->nodok.'"  target="_blank"  title="Cetak SPK"><i class="glyphicon glyphicon-trash"></i> Cetak SPK </a>';		
			}
