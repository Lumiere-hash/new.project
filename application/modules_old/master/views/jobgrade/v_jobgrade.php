						...
						<div class="box">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-striped" >
                                    ...
                                    <tbody>
									<?php $no=0; foreach($list_jobgrade as $row): $no++;?>
								<tr>
									...
									<td><a href="<?php echo site_url('master/jabatan/hps_jobgrade').'/'.$row->kdgrade;?>" OnClick="return confirm('Anda Yakin Hapus <?php echo trim($row->kdgrade);?>?')"><i class="fa  fa-trash-o"><i> Hapus</a></td>
									<td><a data-toggle="modal" data-target="#<?php echo trim($row->kdgrade);?>" href="#" ><i class="fa  fa-edit"><i>Edit</a></td>
								</tr>
								<?php endforeach;?>	
                                    </tbody>
                                </table>
	  ...
	  <div class="modal-header">
		...
		<form role="form" action="<?php echo site_url('master/jabatan/add_jobgrade');?>" method="post">
				...
				<div class="col-sm-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-24">
								...
								<input type="text" id="bobot1" name="bobot1"  data-inputmask='"mask": "999"' data-mask="" class="form-control">
            ...
            <div class="form-group">
				...
				<div class="col-sm-12">
						<div>
						 <textarea  class="form-control" name="ket"   style="text-transform:uppercase" ></textarea>
...
<div class="modal fade" id="<?php echo trim($lg->kdgrade);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
	<div class="modal-content">
	  <div class="modal-header">
		<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
		...
		<form role="form" action="<?php echo site_url('master/jabatan/edit_jobgrade');?>" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
						...
						<input type="text" id="bobot1" name="bobot1" value="<?php echo $lg->bobot1;?>"  data-inputmask='"mask": "999"' data-mask="" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <select class="form-control input-sm" name="kdlvlgpmin" id="kdlvlgpmin" required>
                        <option value="" ><?php echo '-- PILIH GP MINIMAL RANGE ---';?></option>
                        <?php foreach($list_kdlvl as $lkd){?>
                            <option <?php if (trim($lkd->kdlvlgp)==trim($lg->kdlvlgpmin)) { echo 'selected';}?> value="<?php echo trim($lkd->kdlvlgp);?>" ><?php echo $lkd->kdlvlgp;?></option>
                        <?php }?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <select class="form-control input-sm" name="kdlvlgpmax" id="kdlvlgpmax" required>
                        <option value="" ><?php echo '-- PILIH GP MAKSIMAL RANGE ---';?></option>
                        <?php foreach($list_kdlvl as $lkd){?>
                            <option <?php if (trim($lkd->kdlvlgp)==trim($lg->kdlvlgpmax)) { echo 'selected';}?> value="<?php echo trim($lkd->kdlvlgp);?>" ><?php echo $lkd->kdlvlgp;?></option>
                        <?php }?>
                    </select>
                </div>
            </div>
			<div class="form-group">
				...
				<div class="col-sm-12">
						...
						<div>
						 <textarea  class="form-control" name="ket"   style="text-transform:uppercase"  ><?php echo $lg->keterangan;?></textarea>
					</div>
