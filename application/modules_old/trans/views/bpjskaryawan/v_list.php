	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				...
				<?php } ?>
					<a  href="<?php echo site_url("trans/bpjskaryawan/karyawan")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Kembali</a>
				</div>
				<div class="col-sm-6">
					...
					<tbody>
						...
						<tr>										
							...
							<?php if (trim($akses_list['aksesdelete'])=='t') {?>
								<a  href="<?php $nik=trim($lu->nik); echo  site_url("trans/bpjskaryawan/hps_bpjs/$nik/$lu->id_bpjs")?>" onclick="return confirm('Anda Yakin Hapus Data ini?')" class="btn btn-default  btn-sm">
