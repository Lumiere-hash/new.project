	...
	<div class="col-sm-12">
		...
		<div class="tab-content">
			<div class="chart tab-pane active" id="<?php echo str_replace('.','',trim($lp['nik']));?>tab_1" style="position: relative; height: 300px;" >				
				...
				<!--BUTTON-->
					<div class="form-group">
						<?php /*<div class="col-sm-9" style="margin-top: 10px">											
...
<div class="tab-pane" id="<?php echo str_replace('.','',trim($lp['nik']));?>tab_4">
				<div class="row">
				<?php /*<a href="#" type="button" class="btn btn-default" data-toggle="modal" data-target=".keluarga">Input Keluarga</a>						
						<br><br> */	 ?>			
				  <div class="col-sm-12">
					<table id="example1" class="table table-bordered table-striped" >
					<thead>
...
<!--RIWAYAT KESEHATAN KARYAWAN-->
	<div class="tab-pane" id="<?php echo str_replace('.','',trim($lp['nik']));?>tab_5">
		<div class="row">
			<?php /*	<a href="#" type="button" class="btn btn-default" data-toggle="modal" data-target=".kesehatan">Input Kesehatan</a>						
				<br><br>	*/ ?>
		<div class="col-sm-12">
			<table id="example1" class="table table-bordered table-striped" >
				<thead>
...
<!-- RIWAYAT KERJA DAN PENGALAMAN-->
			<div class="tab-pane" id="<?php echo str_replace('.','',trim($lp['nik']));?>tab_6">
				<div class="row">
				<?php  /*<a href="#" type="button" class="btn btn-default" data-toggle="modal" data-target=".inputkerja">Input Riwayat Kerja</a>						
				  */ ?>
				  <div class="col-sm-12">
				  </BR></BR>
					<table id="example1" class="table table-bordered table-striped" >
...
<!-- INPUT PELATIHAN KARYAWAN -->
			<div class="tab-pane" id="<?php echo str_replace('.','',trim($lp['nik']));?>tab_7">
				<div class="row">
				<?php /*<a href="#" type="button" class="btn btn-default" data-toggle="modal" data-target=".inputpelatihan">Input Pelatihan</a>	
					</br></br> */ ?>
				  <div class="col-sm-12">
					<table id="example1" class="table table-bordered table-striped" >
						<thead>
...
<!--- TAB RIWAYAT PENDIDIKAN KARYAWAN-->
			<div class="tab-pane" id="<?php echo str_replace('.','',trim($lp['nik']));?>tab_8">
				<div class="row">
				<?php /*<a href="#" type="button" class="btn btn-default" data-toggle="modal" data-target=".pendidikan">Input Pendidikan</a>	
</br></br>				*/ ?>
				  <div class="col-sm-12">
					<table id="example1" class="table table-bordered table-striped" >
						<thead>
...
<!--END TAB RIWAYAT PENDIDIKAN KARYAWAN-->
			...
			<div class="tab-pane" id="<?php echo str_replace('.','',trim($lp['nik']));?>tab_9">
				<div class="row">
				<div class="form-group">
				<?php /*	<a href="#" type="button" class="btn btn-default" data-toggle="modal" data-target="#inputbpjs">Input BPJS</a>						
				<br><br>*/ ?>
				<div>										
				  <div class="col-sm-12">
					<table id="example1" class="table table-bordered table-striped" >
