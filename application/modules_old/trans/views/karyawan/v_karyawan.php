...
<!--- DATA KARYAWAN RESIGN -->
    <div class="tab-pane" id="tab_2" style="position: relative; height: 300px;" >
        ...
        <!-- form start -->
                ...
                <!--td><!--?php echo $ls->grouppenggajian;?></td---> <!-- salah cok hahah-->
                <td><a class="btn btn-sm btn-default" href="<?php echo base_url('trans/karyawan/detail_resign').'/'.trim($ls->nik) ?>" title="Detail"><i class="glyphicon glyphicon-pencil"></i> Detail</a></td> <!-- salah cok hahah-->
