...
<div class="row">
						...
						<a href="<?php echo site_url("hrd/report/excel_cuti/$periode");?>"><i class='fa fa-file-text-o'></i> <label>Excel 2007</label></a></p>
						<div class="box">
                                        ...
                                        <tbody>
                                            <?php
											  ...
											  <tr>
												...
												<td><?php if (trim($column->kode)=='B') { echo '<b>TOTAL CUTI '.$column->nmlengkap.' : '.$column->total.'</b>';} 
												else { echo $column->nmlengkap; }?></td>
												<td><?php echo $column->nodokumen;?></td>
												<td><?php echo $column->tglmulai;?></td>
												<td><?php echo $column->tglahir;?></td>
