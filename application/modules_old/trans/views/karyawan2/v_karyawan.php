							...
							<div class="box box-primary" >
								...
								<div class="box-body">
									<div class="form-group">
									  ...
									  <div class="col-sm-9">
										<input name="nik" id="nik" style="text-transform:uppercase;" maxlength="12" placeholder="Nomor Induk Karyawan" class="form-control" type="text" required>
									  </div>
									</div>
									<div class="form-group">
							...
							<div class="box box-primary" >
								...
								<div class="box-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-sm-9">
										<input name="tgllahir" data-date-format="dd-mm-yyyy" placeholder="Tanggal Lahir" class="form-control" id="tgl" type="text" required>
									  </div>
									</div>
									<div class="form-group">
				...
				<div class="col-sm-12">
				  <h3> Step 3</h3>
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="noktp" style="text-transform:uppercase;" placeholder="No Ktp" class="form-control" type="text" required>
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-3">KTP Dikeluaran di</label>
					  <div class="col-sm-9">
						<input name="ktpdikeluarkan" style="text-transform:uppercase;" placeholder="Kota KTP di keluarkan" class="form-control" type="text">
					  </div>
					</div>							
					<div class="form-group">
					...
					<div class="form-group">							  
						<div id="ktpf" class="ktps" style="display:none">
						  ...
						  <div class="col-sm-9">							
								<input type="text" name="tglberlaku" id="tglktp" class="form-control" >							
						  </div>
						</div>
					</div>
					<div class="form-group">
				...
				<div class="col-sm-12">
				  <h3> Step 5</h3>
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="nohp1" style="text-transform:uppercase;" placeholder="Nomor Handphone Utama" class="form-control" type="text" required>
					  </div>
					</div>												
					<div class="form-group">
					  <label class="control-label col-sm-3">NO HP kedua</label>
					  <div class="col-sm-9">
						<input name="nohp2" style="text-transform:uppercase;" placeholder="Nomor Handphone Lainnya" class="form-control" type="text">
					  </div>
					</div>											
					<div class="form-group">
					  <label class="control-label col-sm-3">Email</label>
					  <div class="col-sm-9">
						<input name="email" style="text-transform:uppercase;" placeholder="Alamat email" class="form-control" type="email">
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">    
							<select name="grade_golongan" id='jobgrade' class="form-control col-sm-12" >
								...
								<option value="<?php echo trim($logjab->kdgrade);?>" class="<?php echo trim($logjab->kdlvl);?>"><?php echo trim($logjab->nmgrade);?></option>																																																			
								<?php };?>
							</select>
						</div>
					</div>
				...
				<div class="col-sm-12">
				  <h3> Step 7</h3>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="gajipokok" style="text-transform:uppercase;" placeholder="Gaji Pokok" class="form-control" type="text" required>
					  </div>
					</div>
					<div class="form-group">
					  <label class="control-label col-sm-3">Gaji BPJS</label>
					  <div class="col-sm-9">
						<input name="gajibpjs" style="text-transform:uppercase;" placeholder="Gaji BPJS" class="form-control" type="text">
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-9">
						<input name="norek" style="text-transform:uppercase;" placeholder="Nomor Rekening" class="form-control" type="text">
					  </div>
					</div>
					<div class="form-group">
