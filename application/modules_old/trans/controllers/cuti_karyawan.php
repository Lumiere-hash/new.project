...
class Cuti_karyawan extends MX_Controller{
	...
	function index(){
		...
		if($this->uri->segment(4)=="kode_failed")
            ...
            $nodok=$this->uri->segment(5);
            $data['message']="<div class='alert alert-success'>SMS DENGAN DOKUMEN <b>$nodok</b> SUKSES DIKIRIM </div>";
        }
		...
		else if($this->uri->segment(4)=="harus_7hari"){
			$nodok=$this->uri->segment(5);
            $data['message']="<div class='alert alert-danger'>Halo Input Cuti Harus Minimal 7 Hari Sebelumnya !!</div>";
		}
