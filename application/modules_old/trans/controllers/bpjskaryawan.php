...
class Bpjskaryawan extends MX_Controller{
    ...
    function __construct(){
        ...
        $this->load->library(array('form_validation','template','upload','pdf','Fiky_version','Fiky_string','Fiky_menu'));
	...
	function index(){
        ...
        $kodemenu='I.T.A.2'; $versirelease='I.T.A.1/ALPHA.001'; $releasedate=date('2019-04-12 00:00:00');
	...
	function add_bpjs(){
		...
		if ($cek>0){
			redirect("trans/bpjskaryawan/index/$nik/kode_failed");
		} else {
			$this->db->insert('sc_trx.bpjs_karyawan',$info);
			redirect("trans/bpjskaryawan/index/$nik/rep_succes");
		}
	...
	function hps_bpjs($nik,$id_bpjs){
		...
		redirect("trans/bpjskaryawan/index/$nik/del_succes");
	}
