...
class Lembur extends MX_Controller{
	...
	function index(){
		...
		if($this->uri->segment(4)=="kode_failed")
            ...
            $data['message']="<div class='alert alert-danger'>Data Sudah Ada Atau Pernah Di Input Dengan Nik dan Tanggal Tersebut</div>";	
			...
			$data['message']="<div class='alert alert-success'>Dokumen $nodok Berhasil di update </div>";
		}
		else
            $data['message']='';
