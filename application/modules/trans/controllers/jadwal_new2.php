...
class Jadwal_new extends MX_Controller {
	...
	function index()
	{
		...
		if($this->uri->segment(4)=="failed"){
			...
			$thn=$this->uri->segment(6);
			$kdregu=$this->uri->segment(7);
            $data['message']="<div class='alert alert-success'>Data Jadwal Kerja Bulan: <b>$bln</b> Tahun: <b>$thn</b> Regu:  <b>$kdregu</b> Berhasil Di Generate Dari Bulan Sebelumnya</div>";
		}
            ...
            $data['message']="<div class='alert alert-warning'>Berhasil Di Hapus</div>";
...
*/	
	...
	function view_jadwalsebulan(){
		...
		$data['title']="JADWAL KERJA NBI BULANAN";
	...
	function opr_belumjadwal(){
		...
		$data['list_nik']=$this->m_regu->q_cekdtlregu()->result();
		$data['list_regu']=$this->m_jadwalnew->q_regu()->result();
		$data['list_jamkerja']=$this->m_jadwalnew->q_jamkerja()->result();	
		$this->template->display('trans/jadwal/v_inputoprbelum.php',$data);
	...
	function v_gr_jadwal(){
		...
		//$this->db->query("delete from sc_tmp.calendar_jadwal");
