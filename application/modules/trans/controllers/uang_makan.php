...
//        $this->db->query("select sc_tmp.pr_hitung_rekap_sewakendaraan('$kdcabang','$awal', '$akhir')");
    ...
    public function excel_absensi($kdcabang, $awal, $akhir, $borong, $callplan)
    {
        ...
        if ($callplan == "t") {
            $this->excel_generator->set_header(array('NO', 'NIK', 'NAMA', 'DEPARTEMEN', 'JABATAN', 'TANGGAL', 'CHECKTIME', 'CALLPLAN', 'REALISASI', 'KETERANGAN', 'UANG MAKAN', 'BBM', 'BIAYA PERAWATAN', 'SUB TOTAL'));
            ...
            $this->excel_generator->set_header(array('NO', 'NIK', 'NAMA', 'DEPARTEMEN', 'JABATAN', 'TANGGAL', 'CHECKTIME', 'KETERANGAN', 'UANG MAKAN', 'BBM', 'BIAYA PERAWATAN', 'SUB TOTAL'));
