	...
	<div class="col-sm-12">										
		<div class="box">
			<div class="box-header">
				...
				<a href="cuti_karyawan/pr_addcutirata" class="btn btn-warning" style="margin:10px; color:#ffffff;"><?php echo $cek_tglmskkerja['ceker'],' HAK CUTI ULANG TAHUN';?></a>	
				...
				<table id="example1" class="table table-bordered table-striped" >
					...
					<tbody>
						...
						<tr>										
							...
							<td><?php echo $lu->nmatasan1;?></td>
							<td><?php echo $lu->nmatasan2;?></td>
					...
					<div class="box-body">
						<div class="form-horizontal">							
							...
							$(function() {
								...
								$(".subcuti<?php echo trim($lb->nodok); ?>" + $(this).val()).show();
								$('#' + $(this).val()).show();
								});
							});
							</script>
							...
							<div class="form-group">
							<div id="A<?php echo trim($lb->nodok); ?>" class="subcutiA<?php echo trim($lb->nodok);?>" style="display:none;">
