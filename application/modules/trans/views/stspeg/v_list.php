					...
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="nosk" name="nosk" class="form-control" style="text-transform:uppercase" maxlength="15">
								</div>
							</div>	
							<div class="form-group">
						...
						<div class="form-horizontal">							
							...
							<div id="tglmulai2" class="tglmulaiKO" >
								<div class="form-group">
									<label class="col-sm-4">Tanggal Mulai</label>	
									<div class="col-sm-8">    
										<input type="text" id="datemulai2" value="<?php echo $lb->tgl_mulai1;?>" name="tgl_mulai" data-date-format="dd-mm-yyyy"  class="form-control" required>
									</div>
								</div>
							</div>
							<div id="tglselesai2" class="tglselesaiKT" >
								<div class="form-group">	
									<label class="col-sm-4">Tanggal Selesai</label>	
									<div class="col-sm-8">    
										<input type="text" id="datemulai2" value="<?php echo $lb->tgl_selesai1;?>" name="tgl_selesai" data-date-format="dd-mm-yyyy"  class="form-control" required>
									</div>
								</div>	
							</div>
