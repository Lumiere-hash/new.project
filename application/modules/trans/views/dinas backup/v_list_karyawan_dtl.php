...
<legend><?php echo $title;?></legend>
				...
				<div class="col-sm-12">		
					<a href="<?php echo site_url("trans/dinas/cleartmp")?>"  class="btn btn-primary" style="margin:10px; color:#ffffff;">Clear</a>
					...
					<div class="box-body">
						<div class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" id="tglberangkat" name="tglberangkat" value="<?php echo $dtl_dn['tgl_mulai'];?>"  data-date-format="dd-mm-yyyy"  class="form-control" readonly>
								</div>
							</div>	
							<div class="form-group">
								<label class="col-sm-4">Tanggal Kembali</label>	
								<div class="col-sm-8">    
									<input type="text" id="tglkembali" name="tglkembali" value="<?php echo $dtl_dn['tgl_selesai'];?>"  data-date-format="dd-mm-yyyy"  class="form-control" readonly>
								</div>
							</div>								
						</div>
					</div><!-- /.box-body -->													
				</div><!-- /.box --> 
								<button class="btn btn-success " onClick="TEST" type="submit">Simpan Final</button>
									</div>
							</div>
						</div>
					</div>
