    ...
    <div class="box-header">
        <div class="dropdown ">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
                <li role="presentation"><a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#FILTER_MODAL"  href="#"><i class="fa fa-search"></i> Pencarian</a></li>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo site_url("ga/pembelian/list_niksppb")?>"><i class="fa fa-plus"></i> Permintaan PEMBELIAN</a></li>
            </ul>
        </div>
    </div><!-- /.box-header -->
                ...
                <tr>
                    ...
                    <td width="15%">
                        ...
                        <?php if ((trim($row->status)=='P' or trim($row->status)=='S' or trim($row->status)=='U')) { ?>
                            <button class="button btn btn-warning  btn-sm" onClick="window.open('<?php echo site_url("ga/pembelian/sti_sppb_final/$enc_nodok");?>');"  title="PRINT SPPB"><i class="fa fa-print"></i></button>
                        <?php } ?>
                    </td>
                </tr>
            <?php endforeach;?>
