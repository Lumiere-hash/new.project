							...
							<div class='col-sm-6'>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control input-sm tgl" id="tgl" name="tgl"
										...
										value="<?php if (empty(trim($ls->tglakhir))) {
											echo '';
										} else {
...
<!-- Modal DETAIL -->
<?php foreach ($list_spk as $ls) { ?>
	<div class="modal fade" id="DTL<?php echo str_replace('.', '', (trim($ls->nodok) . trim($ls->nodokref))); ?>" tabindex="-1"
					...
					<?php } ?>
							...
							<div class='col-sm-6'>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control input-sm tgl" id="tgl" name="tgl"
										data-date-format="dd-mm-yyyy"
										value="<?php if (empty($row->tglakhir)) {
											echo '';
										} else {
											echo date('d-m-Y', strtotime(trim($ls->tglawal))) . ' - ' . date('d-m-Y', strtotime(trim($ls->tglakhir)));
										} ?>"
...
<?php foreach ($perawatan_mst_lampiran as $ls) { ?>
	<div class="modal fade" id="DEL<?php echo str_replace('.', '', (trim($ls->strtrimref))) . trim($ls->id); ?>" tabindex="-1"
		role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
