...
<script>
    $(document).ready(function() {
        ...
        $('button.download').on('click', function () {
            window.location.replace('<?php echo site_url('kasbon_umum/declarationcashbondinas/exportpdf/'.bin2hex(json_encode(array('declarationid' => $declaration->declarationid, )))) ?>?' + $('form.formprintoption').serialize())
        });
