						...
						<div class="col-sm-6 ">
							<div class="box box-primary" >
								...
								<div class="box-body">
								  ...
								  <label class="control-label col-sm-3">Pilih Dari Daftar KTP Pelamar</label>
									<div class="col-sm-9">
										<select  name="dfktp" id="dfktp" style="text-transform:uppercase;"  class="form-control" type="text">
							...
							$(function() {
								...
								<div class="form-group ktp1">
								  ...
								  <div class="col-sm-9">
									<input name="noktp1" id="noktp1" style="text-transform:uppercase;" placeholder="No KTP" class="form-control" type="text" maxlength="18" required>
								  </div>
								</div>
								<div class="form-group">
								...
								<div class="form-group ktp2">
								  <label class="control-label col-sm-3">Pilih KTP Dari Pelamar</label>
									<div class="col-sm-9">
										<select  name="noktp2" id="noktp2" style="text-transform:uppercase;"  class="form-control" type="text" required>
											<!--option value=""><?php echo '---PILIH KTP DAN NAMA KARYAWAN---';?></option-->
	...
	<!-- form start -->
			...
			<td width='20%'>
				...
				<div class="pull-left image">
					<img height='100px' width='100px' alt="User Image" class="img-box" src="<?php echo base_url('/assets/img/profile/').'/'.$ls->image;?>">
				</div>				
