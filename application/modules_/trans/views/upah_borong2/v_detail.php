					...
					<tbody>
						...
						<tr>										
							...
							<td>
								...
								<a href="<?php $nik=trim($lu->nik); echo site_url("trans/upah_borong/final_mst/$lu->nodok")?>" onclick="return confirm('Anda Yakin Approval Data ini?')" class="btn btn-default  btn-sm">
					...
					<div class="box-body">
						<div class="form-horizontal">							
							...
							<div class="form-group">
								<label class="col-sm-4">Pencapaian</label>	
								<div class="col-sm-8">    
									<input type="number" id="gaji" value="<?php echo $lb->pencapaian ;?>" name="pencapaian" placeholder="0"   class="form-control" required>
								</div>
							</div>	
							<div class="form-group">
								<label class="col-sm-4">Upah Borong</label>	
								<div class="col-sm-8">    
									<input type="number" id="gaji" value="<?php echo $lb->upah_borong ;?>" name="upah_borong" placeholder="0"   class="form-control" required>
								</div>
							</div>	
							<div class="form-group">
								<label class="col-sm-4">Catatan</label>	
