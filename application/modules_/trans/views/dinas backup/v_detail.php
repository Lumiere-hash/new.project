...
<div class="modal-body">										
					...
					<div class="box-body">
						...
						<div class="form-horizontal">	
							...
							<div class="form-group">
								...
								<div class="col-sm-8">    
									<input type="text" value="<?php echo trim($lb->tgl_mulai); ?>" id="tglberangkat" name="tglberangkat" data-date-format="dd-mm-yyyy"  class="form-control" readonly>
								</div>
							</div>	
							<div class="form-group">
								<label class="col-sm-4">Tanggal Kembali</label>	
								<div class="col-sm-8">    
									<input type="text"  value="<?php echo trim($lb->tgl_selesai); ?>" id="tglkembali" name="tglkembali" data-date-format="dd-mm-yyyy"  class="form-control" readonly>
								</div>
							</div>								
						</div>
	...
	<div class="modal-footer">
		<form action="<?php echo site_url('trans/dinas/cancel');?>" method="post">
