...
class Bbmkendaraan extends MX_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model(array('m_kendaraan', 'master/m_akses', 'master/m_geo', 'm_bbmkendaraan'));
    ...
    function input_bbmkendaraan(){
        ...
        $data['title']='INPUT PENCATATAN BIAYA BBM KENDARAAN';
    ...
    function edit_bbmkendaraan(){
        ...
        $paramview=" and docno='$nama'";
        $data['title']='UBAH DATA PEMAKAIAN BAHAN BAKAR KENDARAAN';
        $data['dtlmst'] = $this->m_bbmkendaraan->q_tmp_bbmkendaraan_mst($paramview)->row_array();
    ...
    function cancel_bbmkendaraan(){
        ...
        $paramview=" and docno='$nama'";
        $data['title']='BATAL INPUT PEMAKAIAN BAHAN BAKAR KENDARAAN';
        $data['dtlmst'] = $this->m_bbmkendaraan->q_tmp_bbmkendaraan_mst($paramview)->row_array();
    ...
    function save_bbmkendaraan(){
        ...
        $km_awal=trim($this->input->post('km_awal'));
        $km_akhir=trim($this->input->post('km_akhir'));
    ...
    function sti_bbmkendaraan(){
        ...
        $data['jsonfile'] = "ga/bbmkendaraan/json_bbmkendaraan/$enc_docno/$enc_stockcode";
        $data['report_file'] = 'assets/mrt/sti_bbmkendaraan.mrt';
        $this->load->view("ga/bbmkendaraan/sti_bbmkendaraan",$data);
    }
}