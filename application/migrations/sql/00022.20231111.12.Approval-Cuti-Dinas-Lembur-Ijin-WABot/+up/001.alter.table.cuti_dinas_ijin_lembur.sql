...
$$
    BEGIN
        ...
        END IF;
        IF EXISTS (SELECT column_name FROM information_schema.columns WHERE table_schema = 'sc_trx' AND table_name = 'dinas' AND column_name = 'whatsappaccept' ) THEN
        ...
        END IF;
        IF EXISTS (SELECT column_name FROM information_schema.columns WHERE table_schema = 'sc_trx' AND table_name = 'lembur' AND column_name = 'whatsappaccept' ) THEN
        ...
        END IF;
        IF EXISTS (SELECT column_name FROM information_schema.columns WHERE table_schema = 'sc_trx' AND table_name = 'cuti_karyawan' AND column_name = 'whatsappaccept' ) THEN
        ...
        END IF;
        IF EXISTS (SELECT column_name FROM information_schema.columns WHERE table_schema = 'sc_trx' AND table_name = 'ijin_karyawan' AND column_name = 'whatsappaccept' ) THEN
